...
test.describe('Business scenario', () => {
  ...
  await test.step("System must allow user to access the login page", async () => {
    // System must allow user to access the login page
    const screenshot = await page.screenshot();
    await testInfo.attach("System must allow user to access the login page", { body: screenshot, contentType: 'image/png' });
  });
