...
test.describe('Business scenario', () => {
  ...
  await test.step("https://opensource-demo.orangehrmlive.com/", async () => {
    // https://opensource-demo.orangehrmlive.com/
    const screenshot = await page.screenshot();
    await testInfo.attach("https://opensource-demo.orangehrmlive.com/", { body: screenshot, contentType: 'image/png' });
  });

  await test.step("1. Login Module- User Acceptance Criteria", async () => {
    // 1. Login Module- User Acceptance Criteria
    const screenshot = await page.screenshot();
    await testInfo.attach("1. Login Module- User Acceptance Criteria", { body: screenshot, contentType: 'image/png' });
  });
